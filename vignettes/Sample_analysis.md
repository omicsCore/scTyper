...
**cells.test_excluded** The value is a cell to be excluded from the inferCNV process in T test. </br>
**cells.test_reference** The value containing the classification of the reference cell to be used from the inferCNV process in T test.</br>
