#' @title scTyper
#' @description Run scTyper pipeline
#' @usage scTyper()
...
#' @param seurat.object Seurat object, if user don't have pre-processed seurat object, user have to insert reference seurat object
#' @param slot Data type of Seurat object, c("scale.data", "count.data", "data")
#' @param marker Cell markers to use cell typing, Character or List (Signature names or Study names or User defined gene list)
...
scTyper<- function(wd=getwd(),
  ...
  ##cell typing
  seurat=cell.typing.seurat(seurat=seurat, marker=marker, wd=wd, slot=slot, cell.typing.method=cell.typing.method, level=level, assay=assay, ntp.dir=ntp.dir, rda.dir=rda.dir, NTP.g.filter.method=NTP.g.filter.method, NTP.gene.filter.cutoff=NTP.gene.filter.cutoff, NTP.distance=NTP.distance, NTP.norm.method=NTP.norm.method, mc.cores=mc.cores)
