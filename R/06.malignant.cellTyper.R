...
#' @description A wrapper function to malignant.cellTyper
#' @usage malignant.cellType(seurat, rda.dir = "./data", malignant.cell.type="Epithelial_cell", cnv.ref.type = c("cell.type","tissue.type"), cnv.ref.name="Normal")
