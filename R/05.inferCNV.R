...
#' @usage run.inferCNV(seurat, assay='RNA', output.dir = "./", rda.dir = "./data", fdata, pheno_info = pheno.df, cnv.ref.type = c("tissue.type", "cell.type"), cnv.ref.name = "Normal", t.test.fc.cutoff = 0.05, t.test.exclude.cell.type = ("Epithelial_cell", "Unresolved_cell"), min_mean_expr_cutoff = 0.1, window_length = 101, smooth_ends = TRUE, recenter_method = "median", ordered = FALSE, inv_log = TRUE, sd_amplifier = 1.5, bp = 1000000, sd.cut = 0.3, mc.cores=1)
...
#' @import parallel, infercnv, Biobase, S4Vectors, GenomicRanges
#' @export
...
get.geneClust=function(gr, bp=1000000){
  ...
  #seqnames=as.character(unique(seqnames(gr)))
