...
#' @usage run.inferCNV(seurat, assay, output.dir, rda.dir, fdata, pheno_info = pheno.df, feature.to.test, cells.test_reference, cells.test_excluded, fc.cutoff = 0.05, cutoff.gene.cluster=0.05, min_mean_expr_cutoff = 0.1, window_length = 101, smooth_ends = TRUE, recenter_method = "median", ordered = FALSE, inv_log = TRUE, sd_amplifier = 1.5, bp = 1000000, sd.cut = 0.3, mc.cores=1)
