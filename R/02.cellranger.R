...
#' @description A wrapper function to run CellrangerCount
#' @usage CellrangerCount(cellranger.path, fastq.dir, cellranger.ref.dir, output.dir, sample.name, run.cmd=TRUE, mc.cores=1)
