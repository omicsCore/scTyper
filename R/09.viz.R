...
#' @title draw.heatmap
#' @description Visualize result heatmap of scTyper
#' @usage draw.heatmap(seurat, wd, run.inferCNV=TRUE, slot=c("scale.data", "count.data", "data"), marker="Puram.2017.HNSCC.TME")
...
#' @description Visualize result cnv distribution of scTyper
#' @usage cnv.distribution(seurat, wd, marker="Puram.2017.HNSCC.TME", slot=c("scale.data", "count.data", "data"))
#' @param seurat seurat object
#' @param wd working directory
#' @param marker cell type marker
#' @param slot assay data type of seurat object, c("scale.data", "count.data", "data")
