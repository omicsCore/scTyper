...
#' @usage cell.typing.seurat(seurat, marker="Puram.2017.HNSCC", cell.typing.method, level, wd, slot, assay='RNA', ntp.dir, rda.dir, NTP.g.filter.method, NTP.gene.filter.cutoff=0.3, NTP.distance, NTP.norm.method, mc.cores=1)
