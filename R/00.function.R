#' @title make.color.sample
#' @description make ramdom colors
#' @usage make.color.sample(n)
...
#' @usage get.markerList(wd, marker)
#' @description get markerList from scTyper databse
